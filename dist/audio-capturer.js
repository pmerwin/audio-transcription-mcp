...
export class AudioCapturer {
     ...
     */
    async findAudioDeviceIndex(nameSubstr) {
        return new Promise((resolve) => {
            ...
            proc.on("close", () => {
                ...
                const exact = matches.find((x) => x.name.toLowerCase().includes(nameSubstr.toLowerCase()));
                if (exact)
                    return resolve(exact.index);
...
//# sourceMappingURL=audio-capturer.js.map